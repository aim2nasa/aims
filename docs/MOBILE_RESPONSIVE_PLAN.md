...
| 항목 | 상태 | 파일 |
|------|------|------|
| 3-1. 고객 카드 | ⬜ 대기 | `AllCustomersView.css` |
| 3-2. 검색/필터 축소 | ⬜ 대기 | `AllCustomersView.css` |
...
|------|-------|------|------|
| 2026-02-04 | - | 계획 수립 | - |
| 2026-02-04 | 1 | 기반 레이아웃 완료 (Header/CenterPane/Breadcrumb) | 커밋 예정 |
| 2026-02-04 | 2 | 전체 문서 보기 카드형 레이아웃 완료 | 커밋 예정 |
