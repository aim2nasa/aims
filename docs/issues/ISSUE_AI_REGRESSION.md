...
> 작성일: 2026-04-07
> 상태: **방안 D 완료 — 41/44 PASS (93%), 잔여 3건은 문서 검색/비결정성**
...
| 2026-04-07 | Step 5 | 프롬프트만으로 한계 확인. 방안 D(통합 도구) 선택 |
| 2026-04-07 | 방안 D | search_customer_with_contracts 통합 도구 구현 |
| 2026-04-07 | 방안 D | 고객명 금지 하네스 추가 (MCP description/프롬프트에 실제 고객명 → FAIL) |
| 2026-04-07 | 방안 D | 기존 위반 정리: 도구 description/프롬프트에서 실제 고객명 → [고객명] 교체 |
| 2026-04-07 | 방안 D | 3차 regression → **41/44 PASS (93%)**, 22→3 FAIL |
| 2026-04-07 | 잔여 | REG-001/002: 문서 검색 체이닝 — 별도 대응 필요 |
