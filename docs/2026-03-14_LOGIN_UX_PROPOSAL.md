...
| S12 | Idle timeout(PC 30분, 모바일 10분) 후 | PIN 재입력 요구 | [ ] |
...
| M12 | Idle timeout(모바일 10분) | 5분 미사용 시 PIN 재입력 | [ ] |
...
| 자동 잠금(Idle Timeout) 필요 | **반영 완료** (4.6절: PC 30분, 모바일 10분) |
