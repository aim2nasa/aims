...
- RightPane 닫힘 애니메이션: 600ms
- setTimeout 대기: 400ms
- **지도 복원 시작**: RightPane 애니메이션 ~67% 지점 (중간쯤)

### 최적화 효과
- ✅ 지도와 RightPane이 동시에 움직이는 것처럼 보임
- ✅ 사용자 인터랙션 후 즉각적인 반응
- ✅ 애니메이션 충돌 없음 (테스트 검증 완료)
...
**해결**: 400ms로 단축하여 RightPane 애니메이션 중간에 지도 복원 시작
**효과**: 43% 지연 감소, 동시 움직임 효과로 즉각적인 UX
**검증**: 100회 연속 테스트 통과 (300/300, 100% 성공)
