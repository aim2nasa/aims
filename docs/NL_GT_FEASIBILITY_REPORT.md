...
| 1 | MCP 도구 확장 — summary 집계, 날짜 필터/정렬 추가 | `contracts.ts` 수정 | ✅ 완료 (Gini PASS) |
| 3 | 시스템 프롬프트에 Q4/Q6/Q7 도구 선택 가이드 추가 | `chatService.js` 수정 | ✅ 완료 |
| 4 | Regression 테스트 실행 — 29/29 PASS (0 FAIL, 5 WARN) | 기존 `run_regression.py` 활용 | ✅ 완료 (2026-03-21) |
| 5 | 반복 개선 | 다음 라운드에서 GT 80건 기반 심화 평가 | 대기 |
