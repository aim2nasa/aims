...
if ($Chosung) {
    java "-Dfile.encoding=UTF-8" -jar C:\Sikulix\sikulixide-2.0.5.jar -r D:\aims\tools\MetlifePDF_v2.sikuli\MetlifeCustomerList.py -- --chosung $Chosung
} else {
    java "-Dfile.encoding=UTF-8" -jar C:\Sikulix\sikulixide-2.0.5.jar -r D:\aims\tools\MetlifePDF_v2.sikuli\MetlifeCustomerList.py
}
