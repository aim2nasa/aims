...
```powershell
cd D:\aims\tools\MetlifePDF.sikuli\scripts
...
```cmd
D:\aims\tools\MetlifePDF.sikuli\run_verify_integrated_view.bat verify_customer_integrated_view.py
```
...
| 항목 | 경로 |
|------|------|
| 실행 로그 | `D:\aims\tools\MetlifePDF.sikuli\debug_log.txt` |
| 스크린샷 | `D:\aims\tools\MetlifePDF.sikuli\screenshots\` |
