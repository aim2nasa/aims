...
click(Pattern("1769097475678.png").targetOffset(85, 0))  # 드롭다운 클릭
print("        -> 드롭다운 클릭 완료, 메뉴 대기 중...")
sleep(3)  # 드롭다운 메뉴가 열릴 시간 충분히 확보

# "모집" 옵션이 나타날 때까지 대기 (최대 5초)
if not exists("1769013031345.png", 5):
    print("[ERROR] 드롭다운 메뉴에서 '모집' 옵션을 찾을 수 없음!")
    print("        -> 드롭다운이 제대로 열리지 않았거나 이미지 재캡처 필요")
    exit(1)

click("1769013031345.png")  # "모집" 선택
sleep(3)
print("        -> '모집' 선택 완료")

# 모집 선택 검증
print("        -> 모집 선택 검증...")
if not exists("1769096267333.png"):
...
found_img = find_any("1769013114864.png", "1769095061022.png", "1769095119885.png")
if found_img == "1769013114864.png":
...
print("        -> 정렬 상태 검증...")
sleep(3)
if not exists("1769013114864.png"):
