      ...
      <div className="login-container">
        ...
        <div className="login-content">
          ...
          <div className="social-login-buttons">
            ...
            <button type="button" className="social-login-button social-login-button--disabled" disabled aria-label="네이버 로그인 (준비 중)">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M12.1875 9.5625L5.4375 0H0V18H5.8125V8.4375L12.5625 18H18V0H12.1875V9.5625Z" fill="currentColor" />
              </svg>
              <span>네이버 로그인</span>
            </button>

            <button type="button" className="social-login-button social-login-button--disabled" disabled aria-label="구글 로그인 (준비 중)">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M17.64 9.205c0-.639-.057-1.252-.164-1.841H9v3.481h4.844a4.14 4.14 0 01-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.875 2.684-6.615z" fill="currentColor" />
