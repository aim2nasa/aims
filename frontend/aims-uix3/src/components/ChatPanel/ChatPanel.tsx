...
const HELP_FEATURES = [
  ...
  // 인사이트 분석 (Phase 3 추가)
  {
    icon: '⭐', title: '고객 가치 분석', desc: 'S/A/B/C/D 등급으로 고객 가치 평가',
    examples: [
      '가장 중요한 고객이 누구야?',
      '상위 10명 고객 가치 분석해줘',
      '이 고객의 가치 점수 알려줘',
  ...
  {
    icon: '🛡️', title: '보장 공백 분석', desc: '부족한 보험 영역 파악',
    examples: [
      '이 고객 보장 부족한 부분 뭐야?',
      '보장 공백이 있는 고객 알려줘',
      '고객에게 추천할 보험 종류 알려줘',
  ...
  {
    icon: '✅', title: '다음 액션 추천', desc: '오늘 해야 할 영업 활동 추천',
    examples: [
      '오늘 뭐 해야 해?',
      '이번 주 할 일 추천해줘',
      '우선순위 높은 고객 알려줘',
  ...
  // 관계 관리 (Phase 1 추가)
  {
    icon: '👨‍👩‍👧', title: '관계 등록', desc: '고객 간 가족/지인 관계 등록',
    examples: [
      '두 고객을 배우자 관계로 등록해줘',
      '부모자녀 관계 추가해줘',
      '친구 관계 등록해줘',
  ...
  // 고객 복구 (Phase 1 추가)
  {
    icon: '♻️', title: '고객 복구', desc: '삭제된 고객 복구',
    examples: [
      '삭제된 고객 목록 보여줘',
      '최근 삭제한 고객 복구해줘',
      '실수로 삭제한 고객 찾아줘',
  ...
  // Annual Report (Phase 2 추가)
  {
    icon: '📅', title: '연차보고서 조회', desc: '고객 연보 목록 및 상태 확인',
    examples: [
      '고객 연보 있어?',
      '연차보고서 파싱 상태 확인해줘',
      '2024년 연보 보여줘',
  ...
  // 유틸리티 (Phase 4 추가)
  {
    icon: '💾', title: '저장소 사용량', desc: '문서 저장 공간 확인',
    examples: [
      '저장소 얼마나 썼어?',
      '용량 남은 거 얼마야?',
      '저장 공간 사용량 보여줘',
  ...
  {
    icon: '❓', title: '도움말/FAQ', desc: '사용 가이드 및 자주 묻는 질문',
    examples: [
      '공지사항 보여줘',
      'FAQ 조회해줘',
      '사용 가이드 알려줘',
