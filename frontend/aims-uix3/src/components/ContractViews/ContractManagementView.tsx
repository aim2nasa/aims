...
export const ContractManagementView: React.FC<ContractManagementViewProps> = ({
  ...
  // contractChanged → TanStack Query invalidateQueries.contractChanged()가
  // ['contracts-list'] queryKey를 직접 무효화하므로 이벤트 리스너 불필요
  ...
  const guideSections: GuideSection[] = [
    ...
    },
    {
      ...
      title: '고객·계약 일괄등록',
      description: '엑셀 파일에서 고객과 계약 데이터를 일괄 등록합니다.',
