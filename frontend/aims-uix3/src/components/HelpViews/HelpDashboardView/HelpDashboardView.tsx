        ...
        <section className="help-dashboard-view__section help-dashboard-view__section--contact">
          <h2 className="help-dashboard-view__section-title">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" opacity="0.85"/>
            </svg>
            문의 연락처
          </h2>
          <div className="help-dashboard-view__contact-info">
            <div className="help-dashboard-view__contact-item">
              <span className="help-dashboard-view__contact-label">고객센터</span>
              <span className="help-dashboard-view__contact-value">1588-0000</span>
            </div>
            <div className="help-dashboard-view__contact-item">
              <span className="help-dashboard-view__contact-label">운영시간</span>
              <span className="help-dashboard-view__contact-value">평일 09:00 ~ 18:00</span>
            </div>
            <div className="help-dashboard-view__contact-item">
