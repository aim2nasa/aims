...
export function getEffectiveMappingWithMap(
  row: CrFileTableRow,
  groupMap: Map<string, CrFileGroup>
): {
  customerId: string | null
  customerName: string | undefined
  newCustomerName: string | undefined
 ...
 */
export function isRowMappedWithMap(row: CrFileTableRow, groupMap: Map<string, CrFileGroup>): boolean {
 ...
 */
export function getRowMappingDisplayTextWithMap(row: CrFileTableRow, groupMap: Map<string, CrFileGroup>): string {
  const mapping = getEffectiveMappingWithMap(row, groupMap)
