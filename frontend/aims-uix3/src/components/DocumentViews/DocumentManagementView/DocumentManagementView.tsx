            ...
            <StatCard
              ...
              icon={
                <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <circle cx="15" cy="15" r="4" fill="var(--color-success)"/>
                  <path d="M13.5 15l1 1 2.5-2.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                </svg>
              }
              color="success"
              isLoading={isStatsLoading}
            ...
            <QuickActionButton
              icon={
                <span className="quick-action-icon-orange">
                  <SFSymbol name="doc-badge-plus" size={SFSymbolSize.CALLOUT} weight={SFSymbolWeight.MEDIUM} />
                </span>
              }
              label="문서 등록"
            ...
            <QuickActionButton
              icon={
                <span className="quick-action-icon-purple">
                  <SFSymbol name="books-vertical" size={SFSymbolSize.CALLOUT} weight={SFSymbolWeight.MEDIUM} />
                </span>
              }
              label="문서 라이브러리"
            ...
            <QuickActionButton
              icon={
                <span className="quick-action-icon-blue">
                  <SFSymbol name="search-bold" size={SFSymbolSize.CALLOUT} weight={SFSymbolWeight.MEDIUM} />
                </span>
              }
              label="문서 검색"
