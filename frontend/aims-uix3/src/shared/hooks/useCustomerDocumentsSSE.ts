...
export function useCustomerDocumentsSSE(
  ...
  const connect = useCallback(() => {
    ...
    if (import.meta.env.DEV) {
      console.log('[CustomerDocumentsSSE] 연결 시작...', { customerId });
    }
  ...
  }, [customerId, enabled, disconnect, onRefresh, onDocumentChange]);
  ...
  }, [customerId, enabled, connect, disconnect, onRefresh]);
