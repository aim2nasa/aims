...
| 서비스 | 포트 | 배포 스크립트 |
|--------|------|---------------|
| aims_api | 3010 | `./backend/api/aims_api/deploy_aims_api.sh` |
| aims_rag_api | 8000 | `./backend/api/aims_rag_api/deploy_aims_rag_api.sh` |
| aims_mcp | 3011 | `./backend/api/aims_mcp/deploy_aims_mcp.sh` |
| pdf_proxy | 8002 | `./backend/api/pdf_proxy/deploy_pdf_proxy.sh` |
| annual_report_api | 8004 | `./backend/api/annual_report_api/deploy_annual_report_api.sh` |
| pdf_converter | 8005 | `./tools/convert/deploy_pdf_converter.sh` |
