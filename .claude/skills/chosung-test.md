...
## 🔴 CRITICAL: 모든 Phase 완료 필수

**Phase 1~4를 모두 실행해야 테스트가 완료된 것이다!**

| Phase | 작업 | 완료 기준 |
|-------|------|----------|
| 1 | SikuliX 테스트 실행 | 백그라운드 실행 시작 |
| 2 | 완료 대기 | "테스트 완료!" 문자열 확인 |
| 3 | 결과 분석 | 로그/JSON 파일 읽기 |
| **4** | **보고서 생성** | **`report_{초성}.md` 파일 생성** |

**⚔️ Phase 4 (보고서 파일 생성)를 빠뜨리면 스킬 미준수!**
**⚔️ 화면에 요약만 출력하는 것은 Phase 4 완료가 아님!**
