...
보험계약: policy(보험증권-보험사 발행 계약확인 문서, 증권번호·보험기간 확정), coverage_analysis(보장분석/보장범위분석 보고서), application(청약서/가입신청서-자동차 외 보험), plan_design(설계서/제안서/비교표/컨설팅/가입제안서/견적/보장내용비교/가입안내서/법인컨설팅/종합재무컨설팅/미처분이익잉여금/치매간병설계), insurance_etc(약관/계약변경/해지/보험가입현황/적립금현황/보유계약리스트/지급내역/질권설정/기타보험/상품설명서/보험명단/해약환급금정리/보험정리표/담보삭제/계약내용변경/자필서류/자필확인서)
...
14. 법인 자동차보험 "가입증"/"증권"/"청약서": corp_asset. 운전자보험 증권→policy, 운전자보험 청약서→application
