...
import { documentToolDefinitions, handleSearchDocuments, handleGetDocument, handleListCustomerDocuments, handleFindDocumentByFilename, handleSearchCustomerDocuments } from './documents.js';
...
import { customerReviewToolDefinitions, handleGetCustomerReviews, handleGetCrContractHistory, handleQueryCustomerReviews } from './customer_reviews.js';
...
const toolHandlers: Record<string, (args: unknown) => Promise<{ content: { type: string; text: string }[]; isError?: boolean }>> = {
  ...
  // 문서 관련
  search_customer_documents: handleSearchCustomerDocuments,
  ...
  query_customer_reviews: handleQueryCustomerReviews,
  // 유틸리티 관련
