...
const faqs = [
  // === 일반 FAQ (15개) ===
  {
    question: "AIMS란 무엇인가요?",
    answer: "AIMS(Agent Intelligent Management System)는 보험 설계사를 위한 지능형 문서 관리 시스템입니다.\n\n주요 기능:\n• 고객 및 계약 정보 관리\n• 문서(보험증권, 청구서 등) 저장 및 검색\n• AI 기반 문서 내용 검색\n• 고객별 문서 연결 및 분류",
    category: "general",
    order: 1,
    isPublished: true,
    createdAt: now,
  ...
  {
    question: "AIMS에서 관리할 수 있는 것은 무엇인가요?",
    answer: "AIMS에서는 다음을 관리할 수 있습니다:\n\n• 고객: 개인/법인 고객 정보, 연락처, 메모\n• 문서: PDF, 이미지 등 고객 관련 서류\n• 계약: 보험 계약 정보, 증권번호, 상품 정보\n\n모든 정보는 고객을 중심으로 연결되어 있어 고객별로 문서와 계약을 한눈에 확인할 수 있습니다.",
    category: "general",
    order: 2,
    isPublished: true,
    createdAt: now,
  ...
  },
  {
    ...
    answer: "AIMS에서 '설계사'는 시스템을 사용하는 보험 영업인(사용자)을 의미합니다.\n\n• 하나의 설계사 계정에 여러 고객을 등록\n• 각 고객에 문서와 계약을 연결\n• 설계사별로 독립된 데이터 공간 제공\n\n즉, 설계사 = 사용자 = 계정 소유자입니다.",
    category: "general",
    order: 8,
    isPublished: true,
    createdAt: now,
