...
class TestHybridSearchEngineInit:
    ...
    @patch('hybrid_search.MongoClient')
    def test_init_connects_to_services(self, mock_mongo, mock_qdrant, mock_openai):
        """초기화 시 MongoDB, Qdrant, OpenAI에 연결해야 함"""
        from hybrid_search import HybridSearchEngine

        mock_mongo.return_value = {"docupload": {"files": MagicMock()}}
...
class TestEntitySearch:
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_entity_search_basic(self, mock_mongo, mock_qdrant, mock_openai):
        """기본 개체명 검색 테스트"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_entity_search_filename_perfect_match(self, mock_mongo, mock_qdrant, mock_openai):
        """파일명 완벽 매칭 시 높은 점수"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_entity_search_empty_keywords(self, mock_mongo, mock_qdrant, mock_openai):
        """검색어 없을 때 빈 결과 반환"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_entity_search_customer_filter(self, mock_mongo, mock_qdrant, mock_openai):
        """고객 ID 필터링"""
        from hybrid_search import HybridSearchEngine
...
class TestVectorSearch:
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_vector_search_basic(self, mock_mongo, mock_qdrant, mock_openai):
        """기본 벡터 검색 테스트"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_vector_search_uses_correct_model(self, mock_mongo, mock_qdrant, mock_openai):
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_vector_search_embedding_error(self, mock_mongo, mock_qdrant, mock_openai, mock_error_log):
        """임베딩 오류 시 빈 결과 반환"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_vector_search_deduplicates_chunks(self, mock_mongo, mock_qdrant, mock_openai):
...
class TestHybridSearch:
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_hybrid_search_merges_results(self, mock_mongo, mock_qdrant, mock_openai):
        """메타데이터 + 벡터 결과 병합"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_hybrid_search_combines_scores(self, mock_mongo, mock_qdrant, mock_openai):
...
class TestSearchRouter:
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_search_routes_entity_query(self, mock_mongo, mock_qdrant, mock_openai):
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_search_routes_concept_query(self, mock_mongo, mock_qdrant, mock_openai):
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_search_routes_mixed_query(self, mock_mongo, mock_qdrant, mock_openai):
...
class TestEmbeddingTracking:
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_stores_last_embedding_response(self, mock_mongo, mock_qdrant, mock_openai):
        """마지막 임베딩 응답 저장"""
        from hybrid_search import HybridSearchEngine
    ...
    @patch('hybrid_search.QdrantClient')
    @patch('hybrid_search.MongoClient')
    def test_clears_embedding_response_on_error(self, mock_mongo, mock_qdrant, mock_openai, mock_error_log):
