 ...
 * ESM Import 테스트
 *
 * aims_mcp (ESM 기반)에서 @aims/shared-schema를 사용할 수 있는지 검증
 */

import assert from 'assert';

// @aims/shared-schema를 import()로 import
import { COLLECTIONS, CUSTOMER_FIELDS, CUSTOMER_TYPES, CUSTOMER_STATUS } from '../dist/esm/index.js';
